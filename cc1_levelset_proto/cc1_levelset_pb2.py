...
_CC1TILECODE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FIRE_BOOTS', index=105, number=105,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
...
_LEVELSET_STORY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='type', full_name='cc1_levelset_utils.Levelset.Story.type', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='text', full_name='cc1_levelset_utils.Levelset.Story.text', index=2,
...
_LEVEL_MAPENTRY = _descriptor.Descriptor(
  name='MapEntry',
  full_name='cc1_levelset_utils.Level.MapEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='cc1_levelset_utils.Level.MapEntry.key', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='cc1_levelset_utils.Level.MapEntry.value', index=1,
...
_LEVEL_TRAPCONTROLSENTRY = _descriptor.Descriptor(
  name='TrapControlsEntry',
  full_name='cc1_levelset_utils.Level.TrapControlsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='cc1_levelset_utils.Level.TrapControlsEntry.key', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='cc1_levelset_utils.Level.TrapControlsEntry.value', index=1,
...
_LEVEL_CLONECONTROLSENTRY = _descriptor.Descriptor(
  name='CloneControlsEntry',
  full_name='cc1_levelset_utils.Level.CloneControlsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='cc1_levelset_utils.Level.CloneControlsEntry.key', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='cc1_levelset_utils.Level.CloneControlsEntry.value', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LEVEL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='trap_controls', full_name='cc1_levelset_utils.Level.trap_controls', index=8,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='clone_controls', full_name='cc1_levelset_utils.Level.clone_controls', index=9,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='movement', full_name='cc1_levelset_utils.Level.movement', index=10,
  ...
  nested_types=[_LEVEL_MAPENTRY, _LEVEL_TRAPCONTROLSENTRY, _LEVEL_CLONECONTROLSENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_LEVELSET_STORY.fields_by_name['type'].enum_type = _LEVELSET_STORY_TYPE
...
_LEVEL_MAPENTRY.fields_by_name['value'].message_type = _TILESPEC
_LEVEL_MAPENTRY.containing_type = _LEVEL
_LEVEL_TRAPCONTROLSENTRY.containing_type = _LEVEL
_LEVEL_CLONECONTROLSENTRY.containing_type = _LEVEL
_LEVEL.fields_by_name['map'].message_type = _LEVEL_MAPENTRY
_LEVEL.fields_by_name['trap_controls'].message_type = _LEVEL_TRAPCONTROLSENTRY
_LEVEL.fields_by_name['clone_controls'].message_type = _LEVEL_CLONECONTROLSENTRY
...
Level = _reflection.GeneratedProtocolMessageType('Level', (_message.Message,), dict(
  ...
  MapEntry = _reflection.GeneratedProtocolMessageType('MapEntry', (_message.Message,), dict(
    ...
    __module__ = 'cc1_levelset_pb2'
    # @@protoc_insertion_point(class_scope:cc1_levelset_utils.Level.MapEntry)
    ))
  ,

  TrapControlsEntry = _reflection.GeneratedProtocolMessageType('TrapControlsEntry', (_message.Message,), dict(
    DESCRIPTOR = _LEVEL_TRAPCONTROLSENTRY,
    __module__ = 'cc1_levelset_pb2'
    # @@protoc_insertion_point(class_scope:cc1_levelset_utils.Level.TrapControlsEntry)
    ))
  ,

  CloneControlsEntry = _reflection.GeneratedProtocolMessageType('CloneControlsEntry', (_message.Message,), dict(
    DESCRIPTOR = _LEVEL_CLONECONTROLSENTRY,
    __module__ = 'cc1_levelset_pb2'
    # @@protoc_insertion_point(class_scope:cc1_levelset_utils.Level.CloneControlsEntry)
    ))
  ,
  DESCRIPTOR = _LEVEL,
  __module__ = 'cc1_levelset_pb2'
...
_sym_db.RegisterMessage(Level.TrapControlsEntry)
_sym_db.RegisterMessage(Level.CloneControlsEntry)
...
_LEVEL_MAPENTRY.has_options = True
_LEVEL_MAPENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
_LEVEL_TRAPCONTROLSENTRY.has_options = True
_LEVEL_TRAPCONTROLSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
_LEVEL_CLONECONTROLSENTRY.has_options = True
_LEVEL_CLONECONTROLSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
