...
_LEVEL = _descriptor.Descriptor(
  ...
  nested_types=[_LEVEL_TRAPCONTROLSENTRY, _LEVEL_CLONECONTROLSENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
